...
本プライバシーポリシーは、[ZER0 DAO](https://zer0.im/)（以下、「管理者」）が本ウェブサイト上で提供するサービス（以下、「本サービス」）における個人情報の取り扱いに関するポリシーを定めるものです。利用者の皆様（以下、「ユーザー」）には、本サービスを利用することで、本プライバシーポリシーに同意したものとみなします。
