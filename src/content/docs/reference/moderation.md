...
### 第3則 運営の介入基準
運営は、利用規約違反が発生した場合にのみ対応します。

#### 介入する場合
- 利用規約に明記された禁止行為が行われた場合
- 複数のユーザーから通報があり、具体的な権利侵害が確認された場合
- サーバーの技術的運営に支障をきたす場合

#### 介入しない場合
- ユーザー間の意見の相違や感情的な対立
- 「依存」や「精神的資源の消費」など、主観的判断を要する状況
- グレーゾーン（明確な権利侵害に該当しない行為）
...
#### 解釈指針
1. 本原則は、その字句よりも精神を重視して解釈します
2. 解釈に疑義が生じた場合は、表現の自由を優先します
3. 最終的な判断は運営の合議によります
