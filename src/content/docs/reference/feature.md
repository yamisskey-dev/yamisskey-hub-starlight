...
|----------|------------|------------------|------------|--------------|----------|
| アドミン | 管理人 | 公開 | 公開 | オン | ベースロールと同じ |
| テスター | 一般ユーザー | 公開 | 非公開 | オン | ベースロールと同じ |
| モデレーター | モデレーター | 公開 | 公開 | オン | ベースロールと同じ |
| フィクサー | モデレーター | 非公開 | 非公開 | オフ | ベースロールと同じ |
| ディベロッパー | 一般ユーザー | 公開 | 非公開 | オフ | Webhook発行可能 |
| インフルエンサー | 一般ユーザー | 非公開 | 非公開 | オフ | 招待コード発行可能 |
| ボット | 一般ユーザー | 公開 | 非公開 | オフ | bot動作に必要最小限の権限 |
| センサー | 一般ユーザー | 公開 | 非公開 | オフ | フォロー解除通知・ブロックされた通知・ブロック解除された通知を許可 |
| ジプシー | 一般ユーザー | 公開 | 非公開 | オフ | アカウントへの各種インポート権限 |
| アーカイバー | 一般ユーザー | 公開 | 非公開 | オフ | csv/zipファイルのインポート/エクスポート |
| シャドウバン | 一般ユーザー | 非公開 | 非公開 | オフ | コンディショナルロールから除外、隔離 |
...
| 界隈 | 一般ユーザー | 非公開 | 非公開 | オフ | ローカルユーザー | LTLとGTLとインスタンス統計の閲覧、パブリック投稿とチャットを許可 |
| 闇垢 | 一般ユーザー | 非公開 | 非公開 | オフ | やみモード | やみTL閲覧とやみ投稿を許可、LTLとSTLを非表示 |
