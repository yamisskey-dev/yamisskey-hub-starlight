...
| 患者 | 一般ユーザー | 非公開 | 非公開 | オフ | ローカルユーザー | LTLとGTLとインスタンス統計の閲覧を許可 |
| 月見 | 一般ユーザー | 非公開 | 非公開 | オフ | ローカルユーザー | やみTL閲覧とやみ投稿を許可 |
| 活発 | 一般ユーザー | 非公開 | 非公開 | オフ | アクティブユーザー | レート制限100%に緩和 |
| 疎通 | 一般ユーザー | 非公開 | 非公開 | オフ | 新規登録から1時間が経過 | メンション数3までリプライを許可、パブリック投稿と連合あり投稿を許可 |
