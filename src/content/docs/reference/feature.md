...
- チャンネルを閲覧できる
- 「見つける」を閲覧できる
- 「アカウントを見つけやすくする」有効、またはフォロワー数が5人以上なら、ノート検索できる
...
※連合ありやみノートは、信頼済みサーバーのみに配送され、リノート不可
...
| 開発者 | 一般ユーザー | 公開 | 非公開 | オフ | Webhook発行可能 |
...
| 亡命 | 一般ユーザー | 公開 | 非公開 | オフ | アカウントへの各種インポート権限 |
| 保護観察 | 一般ユーザー | 非公開 | 非公開 | オフ | コンディショナルロールから除外、隔離 |

### コンディショナルロール（権限系）
| ロール名 | 権限レベル | プロフィール公開 | バッジ公開 | ユーザー発見 | 取得条件 | 追加権限 |
|----------|------------|------------------|------------|--------------|------------|----------|
| 速水 | 一般ユーザー | 非公開 | 非公開 | オフ |「新規登録から1か月以内」かつ「最終アクティブ日時が3分未満」 | レートリミット120% |
| 兄弟 | 一般ユーザー | 非公開 | 非公開 | オフ | 「鍵アカウント」無効、または「フォロワー数が5人以上」 | ノート検索可能 |
| 同士 | 一般ユーザー | 非公開 | 非公開 | オフ | 「アカウントを見つけやすくする」有効、または「フォロワー数が5人以上」 | ユーザー検索可能 |
| 職人 | 一般ユーザー | 非公開 | 非公開 | オフ | 投稿数50以上 | カスタム絵文字とアバターデコレーションとコミュニティロールを管理可能 |
| 患者 | 一般ユーザー | 非公開 | 非公開 | オフ | ローカルユーザー | LTLとGTLとインスタンス統計の閲覧、パブリック投稿とチャットを許可 |
| 月見 | 一般ユーザー | 非公開 | 非公開 | オフ | やみモード | やみTL閲覧とやみ投稿を許可、LTLとSTLを非表示 |
| 疎通 | 一般ユーザー | 非公開 | 非公開 | オフ | アカウント作成から1時間が経過 | メンション数3までリプライ、連合あり投稿を許可 |
...
| ロール名 | 権限レベル | プロフィール公開 | バッジ公開 | ユーザー発見 | 取得条件 | 追加権限 |
|----------|------------|------------------|------------|--------------|------------|----------|
| VISITOR | 一般ユーザー | 公開 | 公開 | オン | 新規登録後、～1週間 | 各容量制限0.6倍 |
| NEW USER | 一般ユーザー | 公開 | 非公開 | オン | 新規登録後、1週間～1か月 | 各容量制限0.8倍 |
| USER | 一般ユーザー | 公開 | 非公開 | オン | 新規登録後、1か月～半年 | 各容量制限1倍 |
| KNOWN USER | 一般ユーザー | 公開 | 非公開 | オン |新規登録後、半年～1年 | 各容量制限1.2倍 |
| TRUSTED USER | 一般ユーザー | 公開 | 非公開 | オン | 新規登録後、1年 | 各容量制限1.4倍 |
