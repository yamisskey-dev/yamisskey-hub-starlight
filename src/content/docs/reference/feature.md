...
|----------|------------|------------------|------------|--------------|----------|
| 牧師 | 管理人 | 公開 | 公開 | オン | ベースロールと同じ |
| 書記 | 一般ユーザー | 公開 | 非公開 | オン | ベースロールと同じ |
| 弟子 | モデレーター | 非公開 | 非公開 | オフ | ベースロールと同じ |
| 大工 | 一般ユーザー | 公開 | 非公開 | オフ | Webhook発行可能 |
| 布教者 | 一般ユーザー | 非公開 | 非公開 | オフ | 招待コード発行可能 |
| 使徒 | 一般ユーザー | 公開 | 非公開 | オフ | bot動作に必要最小限の権限 |
| 預言者 | 一般ユーザー | 公開 | 非公開 | オフ | フォロー解除通知・ブロックされた通知・ブロック解除された通知を許可 |
| 旅人 | 一般ユーザー | 公開 | 非公開 | オフ | アカウントへの各種インポート権限 |
| 棟梁 | 一般ユーザー | 公開 | 非公開 | オフ | csv/zipファイルのインポート/エクスポート |
| 幽閉 | 一般ユーザー | 非公開 | 非公開 | オフ | コンディショナルロールから除外、隔離 |
