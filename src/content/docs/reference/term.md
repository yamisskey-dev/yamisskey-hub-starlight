...
### 7項（詳細規定）
運営体制の詳細については「[運営体制と権限](/reference/administration/)」を、ユーザー向けの運営ガイドについては「[運営について](/guides/operation/)」を参照してください。
...
1. **提案**: 運営に関わるユーザー（yamisskey-dev開発部、やみすきー運営部、管理人）がSnapshotを通じて変更案をYAMI DAOに提出する
2. **公開期間**: 変更案は最低14日間公開され、ユーザーからの意見を受け付ける
3. **投票**: YAMI DAOにおいてSnapshot投票を実施する
...
- 2026年1月22日　改定：4つの倫理的原則の明記、運営体制の再構築、DAO投票による規約改定手続きの導入