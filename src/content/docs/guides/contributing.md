...
* **マージ前のプルリクエスト必須**：直接pushではなくプルリクエストを通じた変更のみが許可されます
* **レビュー承認必須**：少なくとも1人の承認が必要です
* **新しいコミットが追加された場合の承認リセット**：レビュー後に変更があった場合は再承認が必要です
* **マージ前の会話解決必須**：すべてのコメントや議論は解決する必要があります
* **強制プッシュの禁止**：ブランチ履歴の書き換えを防止します
