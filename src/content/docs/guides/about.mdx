...
病みと闇を大切にするやみすきーは、これらの理念を実現するため、<Badge text="独自機能" variant="tip" />を追加した [Misskey フォーク Yamisskey](https://github.com/yamisskey-dev/yamisskey) を使用しています。

## 制定日・改定履歴

<Aside type="tip" title="変更履歴の追跡について">
GitHubコミットへのリンクを設定し、各改定の具体的な変更内容を追跡できます。
</Aside>
