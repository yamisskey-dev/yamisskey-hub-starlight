...
> ⚠️ **このガイドについて**
>
> このガイドは、私（唯）の個人的な経験をもとにした「快適に過ごすためのヒント集」です。すべて任意の提案であり、強制ではありません。
>
> - **ルールじゃないよ**: 守らなくても制裁されることはありません
> - **自分のペースで**: できる範囲で参考にしてください
> - **表現の自由が最優先**: どんな感情表現も尊重されます
>
> 具体的なルールは[利用規約](https://hub.yami.ski/reference/term/)と[モデレーション原則](https://hub.yami.ski/reference/moderation/)を参照してください。
